...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "whatdoesthesongsays" because\n';
  ...
  $wnd.__gwt_activeModules['whatdoesthesongsays'] = {
    'moduleName' : 'whatdoesthesongsays',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/whatdoesthesongsays.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['whatdoesthesongsays'].superdevmode = true;

  var expectedSuffix = '/whatdoesthesongsays.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + whatdoesthesongsays + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:whatdoesthesongsays';
  var devModeSessionKey = '__gwtDevModeSession:whatdoesthesongsays';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/whatdoesthesongsays/whatdoesthesongsays.nocache.js';
  ...
  $wnd.__gwt_activeModules['whatdoesthesongsays'].canRedirect = true;
  $wnd.__gwt_activeModules['whatdoesthesongsays'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING whatdoesthesongsays';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/whatdoesthesongsays?user.agent=' + ua + '&_callback=' + callback;
